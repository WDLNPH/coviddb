            ...
            <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="px-5 py-7">
                        ...
                        <input id="first_name" type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full @error('email') is-invalid @enderror" name="medicare" value="{{ old('email') }}" required autofocus>
                        <label class="font-semibold text-sm text-gray-600 pb-1 block">Last Name</label>
                        <input id="last_name" type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full @error('email') is-invalid @enderror" name="medicare" value="{{ old('email') }}" required autofocus>
                        ...
                        <input id="dob" type="date" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full @error('password') is-invalid @enderror" name="dob" required>
                    ...
                    <div class="text-center sm:text-left whitespace-nowrap">
                        <a href="/"
                           class="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-200 focus:outline-none focus:bg-gray-300 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                            ...
                            <span class="inline-block ml-1">Back to sign in</span>
                        </a>
                    </div>
                </div>
            </div>
